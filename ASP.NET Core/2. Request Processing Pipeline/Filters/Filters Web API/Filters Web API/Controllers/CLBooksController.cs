...
namespace Filters_Web_API.Controllers
{
    ...
    [ApiController]
    public class CLBooksController : ControllerBase
    {
        #region Private Members
        private readonly BLBooksService _booksService;
        private readonly ILogger<CLBooksController> _logger;
        #endregion

        #region Constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="CLBooksController"/> class.
        /// </summary>
        /// <param name="booksService">The books service to manage book data.</param>
        /// <param name="logger">The logger for logging information.</param>
        public CLBooksController(BLBooksService booksService, ILogger<CLBooksController> logger)
        {
